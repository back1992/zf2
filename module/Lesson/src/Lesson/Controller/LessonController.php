...
// <-- Add this import
use Lesson\Form\Mp3Form;
// <-- Add this import
use Zend\File\Transfer\Adapter\Http;
use Zend\File\Transfer\Transfer;

class LessonController extends AbstractActionController
{
...
// Redirect to list of mp3s
				// return $this->redirect()->toRoute('lesson');
...
// Returns all known internal file information
	...
	public function editAction()
	{
		...
		if (!$id) {
			return $this->redirect()->toRoute('lesson', array(
				'action' => 'add'
				));
		}
...
// Redirect to list of mp3s
	...
	public function getMp3Table()
	{
		if (!$this->mp3Table) {
			...
			$this->mp3Table = $sm->get('Lesson\Model\Mp3Table');
		}
