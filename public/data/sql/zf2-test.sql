...
--
-- 主机: localhost
-- 生成日期: 2013 年 08 月 06 日 04:06
-- 服务器版本: 5.5.31-MariaDB
-- PHP 版本: 5.5.1
...
INSERT INTO `mp3` (`id`, `area`, `title`, `audiofile`, `quiztime`) VALUES
...
INSERT INTO `quiz` (`id`, `area`, `title`, `audiofile`, `quiztime`) VALUES
(1, 'The Military Wives', 'In My Dreams', '', 0),
(3, 'Bruce Springsteen', 'Wrecking Ball (Deluxe)', '', 0),
(5, 'Gotye', 'Making Mirrors', '', 0),
(68, 'test', 'ok', './data/tmpuploads/mp3_51f228faef51a', 0),
